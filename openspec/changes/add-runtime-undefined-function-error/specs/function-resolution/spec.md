...
- **THEN** an `UndefinedFunctionError` is raised with module and function name
...
- **THEN** an `UndefinedFunctionError` is raised
...
- **AND** if missing, raises `UndefinedFunctionError`